...
const AddAddress = () => {
    ...
    const onSubmitHandler = async (e) => {
        e.preventDefault();
        // here we call API to save the address in database and then fetch the address when user login from any device and show it in checkout page and user can select the address for delivery
        try{
